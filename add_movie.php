...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($title) && !empty($release_date)) {
        ...
        if ($selected_date < $current_date) {
            ...
            mysqli_stmt_bind_param($stmt, "ss", $title, $release_date);
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const updateMinDate = () => {
                ...
                const minDate = localTime.toISOString().slice(0, 10); // Format: YYYY-MM-DD
            ...
            <div class="movie-card">
                <div class="movie-table">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <input type="date" name="release_date" id="release_date" min="<?php echo $minDate; ?>" required>
